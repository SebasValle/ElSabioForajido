...
public class EstadoJuego extends Estado {
	...
	public EstadoJuego() {
		...
		if(BackGroundMusicOn == 1) {
			BGmusic = new Sonidos();
			BGmusic.ReproducirSonidoLoop("C:\\Users\\cpere\\Documents\\Ingenieria en Sistemas Computacionales\\CUARTOSEMESTRE\\Programacion orientada a objetos\\sonidos\\No One Like You.wav", 1);
		}
		}
